...
public class GymTrackerGUI extends JFrame {
    ...
    private void crearMenuBar() {
        ...
        itemLista.addActionListener(e -> mostrarListaPrincipal());
    ...
    private JPanel crearPanelPrincipal() {
        ...
        // Título
        JLabel titulo = new JLabel("EJERCICIOS", SwingConstants.CENTER);
        ...
        listaEjercicios.setSelectionBackground(COLOR_FONDO_OSCURO); // Manage selection in renderer
        ...
        listaEjercicios.setCellRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index,
                ...
                card.setBorder(BorderFactory.createCompoundBorder(
                    BorderFactory.createEmptyBorder(0, 0, 10, 0), // Margin bottom
        ...
        JButton btnNuevo = crearBoton("Nuevo", COLOR_ACCENT);
        btnNuevo.addActionListener(e -> mostrarFormulario());
        panelBotones.add(btnNuevo);
        
        JButton btnRefrescar = crearBoton("Refrescar", COLOR_SECUNDARIO);
        btnRefrescar.addActionListener(e -> cargarListaEjercicios());
    ...
    private JPanel crearPanelDetalleEjercicio() {
        ...
        btnVolver.addActionListener(e -> mostrarListaPrincipal());
    ...
    private JPanel crearPanelFormulario() {
        ...
        btnCancelar.addActionListener(e -> mostrarListaPrincipal());
    ...
    private JButton crearBoton(String texto, Color color) {
        ...
        boton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                if (color == COLOR_ACCENT) boton.setBackground(COLOR_ACCENT_HOVER);
                else boton.setBackground(COLOR_SECUNDARIO_HOVER);
            }
    ...
    private void cargarListaEjercicios() {
        listModel.clear();
        List<String> nombres = ejercicioDAO.obtenerNombresEjercicios();
        for (String nombre : nombres) {
            listModel.addElement(nombre);
        }
    }
    
    private void mostrarListaPrincipal() {
        limpiarFormulario();
        cardLayout.show(cardPanel, "PRINCIPAL");
        cargarListaEjercicios();
    }
    ...
    private void cargarUltimoRegistroEnCampos(String nombreEjercicio) {
        ...
        if (!ejercicios.isEmpty()) {
            ...
            if (pesoNuevoField != null) pesoNuevoField.setText(String.format("%.1f", ultimoEjercicio.getPeso()));
            if (repeticionesNuevoField != null) repeticionesNuevoField.setText(String.valueOf(ultimoEjercicio.getRepeticiones()));
            if (fechaNuevoField != null) fechaNuevoField.setText(LocalDate.now().toString());
        } else {
            if (pesoNuevoField != null) pesoNuevoField.setText("0.0");
            if (repeticionesNuevoField != null) repeticionesNuevoField.setText("0");
            if (fechaNuevoField != null) fechaNuevoField.setText(LocalDate.now().toString());
        }
    }
    ...
    private void limpiarFormulario() {
        ...
        if (grupoMuscularCombo != null) grupoMuscularCombo.setSelectedIndex(0);
        if (pesoField != null) pesoField.setText("0.0");
        if (repeticionesField != null) repeticionesField.setText("0");
        if (fechaField != null) fechaField.setText(LocalDate.now().toString());
    }
